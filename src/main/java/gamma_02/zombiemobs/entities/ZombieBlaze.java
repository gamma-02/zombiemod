...
public class ZombieBlaze extends HostileEntity
{
    ...
    public ZombieBlaze(EntityType<? extends ZombieBlaze> entityType, World world) {
    ...
    protected void initGoals() {
        this.goalSelector.add(4, new ZombieBlaze.ShootFireballGoal(this));
    ...
    private static class ShootFireballGoal extends Goal {
        private final ZombieBlaze blaze;
        private int fireballsFired;
        private int fireballCooldown;
        private int targetNotVisibleTicks;

        public ShootFireballGoal(ZombieBlaze blazeEntity) {
