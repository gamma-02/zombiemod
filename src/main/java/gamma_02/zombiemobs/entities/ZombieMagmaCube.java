...
public class ZombieMagmaCube extends SlimeEntity
{
    public ZombieMagmaCube(EntityType<? extends ZombieMagmaCube> entityType, World world) {
    ...
    protected void jump() {
        ...
        this.setVelocity(vec3d.x, (double)(this.getJumpVelocity() + (float)this.getSize() * 0.2F), vec3d.z);
    ...
    protected void swimUpward(Tag<Fluid> fluid) {
        if (fluid == FluidTags.LAVA) {
            Vec3d vec3d = this.getVelocity();
            this.setVelocity(vec3d.x, (double)(0.22F + (float)this.getSize() * 0.1F), vec3d.z);
            this.velocityDirty = true;
        } else {
