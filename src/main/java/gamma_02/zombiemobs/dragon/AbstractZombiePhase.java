...
public abstract class AbstractZombiePhase implements ZombiePhase
{
    protected final ZombieEnderDragon dragon;

    public AbstractZombiePhase(ZombieEnderDragon enderDragonEntity) {
